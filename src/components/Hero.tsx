      ...
      >
         <div className="container relative" ref={parallaxRef}>
            <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem] select-none">
               ...
               <Button className={`left-[50%] -translate-x-[50%]`} white>
                  Get Started
               </Button>
            </div>

            {/* this will be the container for our rest of the container */}
            <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
               <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient ">
                  <div className="relative bg-n-8 rounded-[1rem]">
                     {/* <div className="h-[1.4rem] bg-n-10 rounded-t-2xl  " /> */}
                     <div
                     ...
                     >
                        ...
                        <Generating
                           className={`absolute bottom-5 left-4 right-4 md:left-1/2 md:right-auto md:bottom-8 md:w-[31rem] md:-translate-x-1/2 `}
                        />
